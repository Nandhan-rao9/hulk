...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-zvtcet7rwi40!54ym)o=03k^x(o-vz_#)mbel*uda2cbquf_*v')
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "staticfiles"],  # Serve React index.html
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WHITENOISE_ROOT = STATIC_ROOT  # Serve React build files
WHITENOISE_INDEX_FILE = True  # Serve index.html for SPA routing
